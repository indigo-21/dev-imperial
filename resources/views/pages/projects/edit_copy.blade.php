                        ...
                        <div class="card card-outline card-primary">
                                ...
                                <ul class="nav nav-tabs" id="projectTabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="details-tab" data-toggle="tab" href="#details"
                                            role="tab" aria-controls="details" aria-selected="true">Project
                                            Details</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="documents-tab" data-toggle="tab" href="#documents"
                                            role="tab" aria-controls="documents" aria-selected="false">Project
                                            Files</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" id="costplan-tab" data-toggle="tab" href="#costplan"
                                            role="tab" aria-controls="costplan" aria-selected="false">Cost Plan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="variation-tab" data-toggle="tab" href="#variation"
                                            role="tab" aria-controls="variation" aria-selected="false">Variation
                                            Order</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="projectTabsContent">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="project_reference"
                                                                id="project_reference" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="client_id" id="client_id"
                                                                ...
                                                                <option value="1"
                                                                    {{ $project->client_id == 1 ? 'selected' : '' }}>
                                                                    John Doe Ltd</option>
                                                                <option value="2"
                                                                    {{ $project->client_id == 2 ? 'selected' : '' }}>
                                                                    Acme Construction</option>
                                                                <option value="3"
                                                                    {{ $project->client_id == 3 ? 'selected' : '' }}>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="project_type" id="project_type"
                                                                ...
                                                                <option value="CAT A"
                                                                    {{ $project->project_type == 'CAT A' ? 'selected' : '' }}>
                                                                    CAT A</option>
                                                                <option value="CAT A+"
                                                                    {{ $project->project_type == 'CAT A+' ? 'selected' : '' }}>
                                                                    CAT A+</option>
                                                                <option value="CAT B"
                                                                    {{ $project->project_type == 'CAT B' ? 'selected' : '' }}>
                                                                    CAT B</option>
                                                                <option value="Small Works"
                                                                    {{ $project->project_type == 'Small Works' ? 'selected' : '' }}>
                                                                    Small Works</option>
                                                                <option value="Refurbishment"
                                                                    {{ $project->project_type == 'Refurbishment' ? 'selected' : '' }}>
                                                                    Refurbishment</option>
                                                                <option value="Reconfiguration"
                                                                    {{ $project->project_type == 'Reconfiguration' ? 'selected' : '' }}>
                                                                    Reconfiguration</option>
                                                                <option value="Day 2 Works"
                                                                    {{ $project->project_type == 'Day 2 Works' ? 'selected' : '' }}>
                                                                    Day 2 Works</option>
                                                                <option value="Dilapidation"
                                                                    {{ $project->project_type == 'Dilapidation' ? 'selected' : '' }}>
                                                                    Dilapidation</option>
                                                                <option value="Design Only"
                                                                    {{ $project->project_type == 'Design Only' ? 'selected' : '' }}>
                                                                    Design Only</option>
                                                                <option value="Furniture Only"
                                                                    {{ $project->project_type == 'Furniture Only' ? 'selected' : '' }}>
                                                                    Furniture Only</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="project_size"
                                                                id="project_size" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="0.01" name="client_budget"
                                                                id="client_budget" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="project_director"
                                                                id="project_director" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-check mt-4">
                                                            <input type="checkbox" name="high_risk_building"
                                                                id="high_risk_building" class="form-check-input"
                                                                {{ $project->high_risk_building ? 'checked' : '' }}>
                                                            <label class="form-check-label"
                                                                for="high_risk_building">High Risk Building</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" step="0.01" name="referral_fee"
                                                                id="referral_fee" class="form-control"
                                                ...
                                                <form action="{{ route('projects.update', $project->id) }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group mt-3">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-primary ml-2">Upload</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                    ...
                                    {{-- Cost Plan --}}
                                    <div class="tab-pane fade" id="costplan" role="tabpanel"
                                        aria-labelledby="costplan-tab">
                                                ...
                                                <div class="card card-primary card-outline mb-4">
                                                    <div class="card-header d-flex justify-content-between align-items-center"
                                                        ...
                                                        <div class="d-flex align-items-center ml-auto"
                                                            ...
                                                            <input type="number" step="0.1" min="0"
                                                                ...
                                                                style="width:90px;"
                                                                data-section-id="{{ $section->id }}" value="20">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="section-{{ $section->id }}" class="collapse show">
                                                        ...
                                                        <div class="card-body section-card"
                                                            ...
                                                            {{-- Subtotal row --}}
                                                            <div
                                                                class="form-group row mb-3 section-subtotal-row d-flex justify-content-end">
                                                                <div class="col-auto text-end">
                                                                    <label><strong>Subtotal</strong></label>
                                                                </div>
                                                                <div class="col-auto">
                                                                    <input type="text"
                                                                        class="form-control subtotal-cost" readonly
                                                                        placeholder="Cost">
                                                                </div>
                                                                <div class="col-auto">
                                                                    <input type="text"
                                                                        class="form-control subtotal-total" readonly
                                                                        placeholder="Total">
                                                                </div>
                                                            </div>
                                                            {{-- Add new item --}}
                                    ...
                                    {{-- Variation Order --}}
                                    <div class="tab-pane fade" id="variation" role="tabpanel"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="create-vo-form" style="display: none;">
                                                <form id="variationForm" action="{{ route('section_items.store') }}"
                                                    method="POST">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="variation_order">Variation Order No.</label>
                                                        <input type="text" name="variation_order"
                                                            id="variation_order" class="form-control" readonly>
                                                    </div>
                                                    ...
                                                    @foreach ($items as $item)
                                                        <label class="d-flex align-items-center mb-2 selectable-label">
                                                            ...
                                                            <input type="hidden" name="scope_items[]"
                                                                value="{{ $item }}" disabled>
                                                            <span>{{ $item }}</span>
                                                        </label>
                                                    @endforeach
                                                                ...
                                                                <div class="section-items">
                                                                    ...
                                                                    @if ($index === 0)
                                                                        @foreach ($section2Items as $itemIndex => $item)
                                                                            <div
                                                                                class="form-group row mb-3 section-item-row">
                                                                                <div class="col-md-1">
                                                                                    <label>Code</label>
                                                                                    <input type="text"
                                                                                        name="codes[{{ $index }}][]"
                ...
                costPlanCards.forEach(sectionCard => {
                    ...
                    function updateCostPlanCodes() {
                        sectionCard.querySelectorAll(".section-item-row").forEach((row, index) => {
                            ...
                            if (codeInput) codeInput.value = sectionNumber + "." + String(index + 1)
                                .padStart(2, '0');
                        });
                    }
        ...
        `;
                ...
                document.querySelectorAll('.calc-field').forEach(input => {
                    input.addEventListener('input', function() {
                        ...
                        const markup = parseFloat(sectionCard.querySelector('.markup-input').value) ||
                        0;

                        sectionCard.querySelectorAll('.section-item-row').forEach(row => {
                            const quantity = parseFloat(row.querySelector('.quantity-input')
                                .value) || 0;
                            const rateVal = parseFloat(row.querySelector('.rate-input')
                                .value) || 0;
                            const markupVal = parseFloat(row.querySelector('.markup-input')
                                .value) || 0;
                ...
                document.querySelectorAll('.add-section-item, .remove-row').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        setTimeout(() => updateSubtotals(sectionCard),
                        100); // delay to allow new row creation/removal
                    });
                });
                ...
                document.querySelectorAll('.section-markup-input').forEach(function(headerInput) {
                    ...
                    headerInput.addEventListener('input', function() {
                        ...
                        sectionCard.querySelectorAll('.markup-input').forEach(function(itemInput) {
                            ...
                            itemInput.dispatchEvent(new Event('keyup', {
                                bubbles: true
                            }));
                        });
                    });
